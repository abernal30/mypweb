...
Regarding the MACD, usually traders may buy the security when the MACD (red) crosses above its signal line (`r col1`)  and sell - or short - the security when the MACD (`r col2`) crosses below the signal line (`r col1`).
...
In the BB case, usually traders consider that when the price (`r col1`) continually touches the upper Bollinger Band (`r col2`), it can indicate an overbought signal, while continually touching the lower band (`r col2`) indicates an oversold signal.
